...
Feature: Multiple Photo Journey
  As a tester
  I want to check the Multiple Photo journey functionality
  So that I know that it works and is secure

@wip
 Scenario: Multiple Photo Journey
   Given I go to item type page
   Then I select a item type
   And click Continue button
   Then I should be presented with add photograph page
   When I choose multiple file in add photograph page
   And click Continue button
